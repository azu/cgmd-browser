...
<template>
    <div class="preview-item" ref="outer">
        <div class="viewport"
             :style="viewportStyle">
            <webview autosize="on" src="static/review/index.html" ref="preview" class="webview" id="preview"></webview>
        </div>
    ...
    export default {
        ...
        mounted() {
            this.$refs.preview.addEventListener('did-finish-load', () => {
                ...
                mediator.$on('highlightText', this.highlightText);
                mediator.$on('highlightTextAndJump', this.highlightTextAndJump);
        ...
        `)
          ...
          `)
            ...
            highlightText(text) {
                this.$refs.preview.executeJavaScript(`markText('${escape(text)}')`)
            },
            highlightTextAndJump(text) {
                this.$refs.preview.executeJavaScript(`markTextAndScroll('${escape(text)}')`)
            },
